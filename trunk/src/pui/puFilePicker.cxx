...
void puFilePicker::setChildStyle( int childs, int style )
{
...
void puFilePicker::setChildColour( int childs, int which, float r, float g, float b, float  a )
{
...
void puFilePicker::setChildBorderThickness( int childs, int t )
{
