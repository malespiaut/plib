...
void dGeomRaySet(dxGeom* g, const dVector3 Origin, const dVector3 Direction){
	...
	dMatrix3 Rotation;
  Rotation[0 * 3 + 0] = Right[0];
  Rotation[1 * 3 + 0] = Right[1];
  Rotation[2 * 3 + 0] = Right[2];
  Rotation[3 * 3 + 0] = REAL(0.0);

  Rotation[0 * 3 + 1] = Up[0];
  Rotation[1 * 3 + 1] = Up[1];
  Rotation[2 * 3 + 1] = Up[2];
  Rotation[3 * 3 + 1] = REAL(0.0);

  Rotation[0 * 3 + 2] = Direction[0];
  Rotation[1 * 3 + 2] = Direction[1];
  Rotation[2 * 3 + 2] = Direction[2];
  Rotation[3 * 3 + 2] = REAL(0.0);
...
void dGeomRayGet(dxGeom* g, dVector3 Origin, dVector3 Direction){
	...
	Direction[0] = Rotation[0 * 3 + 2];
	Direction[1] = Rotation[1 * 3 + 2];
	Direction[2] = Rotation[2 * 3 + 2];
	Direction[3] = Rotation[3 * 3 + 2];
}